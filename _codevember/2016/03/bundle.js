...
/***/ function(module, exports, __webpack_require__) {
	...
	var _colourUtils = __webpack_require__(306);
	
	var _shadermaterial = __webpack_require__(303);
	...
	var floor = new THREE.Mesh(new THREE.BoxGeometry(500, 1, 500), new THREE.MeshLambertMaterial({ color: 0x78FFF3 }));
	...
	var update = function update(delta) {
	  ...
	  try {
	    for (var _iterator = cubes[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	      ...
	      var _z2 = _cube.z;
	      var mesh = _cube.mesh;
	      var _amplitude = _cube.amplitude;
	
	      mesh.position.y = _y + Math.sin(delta / 500) * _amplitude.y;
	      mesh.position.x = _x2 + Math.cos(delta / 500) * _amplitude.x;
	      mesh.position.z = _z2 + Math.sin(delta / 500) * Math.cos(delta / 500) * _amplitude.z;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stats = __webpack_require__(301);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vert = __webpack_require__(304);
	
	var _vert2 = _interopRequireDefault(_vert);
	
	var _frag = __webpack_require__(305);
...
/***/ function(module, exports) {
	...
	var generateShades = exports.generateShades = function generateShades(hue, numOfShades) {
	  var low = arguments.length <= 2 || arguments[2] === undefined ? 10 : arguments[2];
	  var high = arguments.length <= 3 || arguments[3] === undefined ? 90 : arguments[3];
