	...
	for (var _x = minX; _x < maxX; _x++) {
	  for (var _z = minZ; _z < maxZ; _z++) {
	    for (var y = minY; y < maxY; y++) {
	      ...
	      var color = pick(_colourUtils.blues);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createScene = exports.createScene = function createScene(_ref) {
	  ...
	  var camera = new THREE.OrthographicCamera(window.innerWidth / -2, window.innerWidth / 2, window.innerHeight / 2, window.innerHeight / -2, -10, 20);
