...
var planeMaker = function planeMaker() {
  var geom = new THREE.PlaneGeometry(10, 10, 10, 10);
...
var mat = new THREE.MeshLambertMaterial({ color: 0xB9E13C });

// === MESH ===

var cmoMat = shaderMaterial;
var cmo = null;
new THREE.JSONLoader().load('/codevember/2016/10/models/cmo.json', function (geometry) {
  var mesh = new THREE.Mesh(geometry, cmoMat);
  cmo = mesh;
